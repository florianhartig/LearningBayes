...
In case you want to run the code yourself, note that a plain R version of the code of each chapter is provided \[here\](https://github.com/florianhartig/LearningBayes/tree/master/classroom)
