...
Laplaces Demon is currently not on CRAN, unfortuanately. You can install the development version directly from GitHub
...
Alternatively, the latest stable release is availabe [here](https://github.com/Statisticat/LaplacesDemon)
