...
2.  Try out more / fewer observations while keeping the ratio constant, and observer how the posterior and all other methods change
3.  Change the code to run with zero observations, and observer how the posterior changes.
:::
...
# Try out the function, and observer how the likelihood changes if you change
# the number of successes an the success probability!
...
#### Bayesian Credibile intervals (CIs)

There basic option to do this is the Bayesian credible interval, which is the analogue to the frequentist confidence interval. The 95 % Bayesian Credibility interval is the centra 95% of the posterior distribution
